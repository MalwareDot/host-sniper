...
def get_arguments():
    ...
    parser.add_argument('--mode', help='mode', dest='mode', choices=('direct', 'proxy', 'ssl', 'udp'), type=str, default='direct')
    parser.add_argument('--method', help='method list', dest='method_list', type=str, default='head')
    parser.add_argument('--port', help='port list', dest='port_list', type=str, default='80')
    parser.add_argument('--proxy', help='proxy', dest='proxy', type=str, default='')
    parser.add_argument('--output', help='output file name', dest='output', type=str)
    parser.add_argument('--threads', help='threads', dest='threads', type=int)
