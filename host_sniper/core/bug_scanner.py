"""
Core scanner base class with multithreading support
"""
from host_sniper.multithreading import MultiThreadRequest


class BugScanner(MultiThreadRequest):
    """Base scanner class with HTTP request handling"""
    threads: int
