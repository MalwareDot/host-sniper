"""
Direct HTTP scanning functionality
"""
from .bug_scanner import BugScanner


class DirectScanner(BugScanner):
    """Direct HTTP scanner for host and port enumeration"""
    method_list = []
    host_list = []
    port_list = []

    def log_info(self, **kwargs):
        """Log formatted scan information"""
    ...
    def get_task_list(self):
        """Generate tasks for all method/host/port combinations"""
